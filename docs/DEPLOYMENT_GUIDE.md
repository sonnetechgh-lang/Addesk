...
2. Run these migration files **in order** (copy-paste each from the `supabase/` folder):
   ...
   | 6     | `supabase/migration_profile_views.sql` | Profile view analytics  |
   | 7     | `supabase/migration_push_subscriptions.sql` | Web push subscriptions |
   | 8     | `supabase/migration_p0_organizations.sql` | Multi-tenancy & orgs   |
   | 9     | `supabase/migration_p1_channels.sql` | Media channels & slots    |
   | 10    | `supabase/migration_p2_campaigns.sql` | Campaigns & clients      |
   | 11    | `supabase/migration_p3_production.sql` | Creative production      |
   | 12    | `supabase/migration_p4_approvals_scheduling.sql` | Approvals & calendar |
   | 13    | `supabase/migration_p5_billing.sql` | Invoicing & payments       |
